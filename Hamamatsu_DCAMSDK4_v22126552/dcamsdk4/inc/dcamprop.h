/* **************************************************************** *
	...
	dcamprop.h:	Feb 25, 2022

	Copyright (C) 2011 - 2022 Hamamatsu Photonics K.K.. All right reserved.
...
typedef enum _DCAMPROPATTRIBUTE
{
	...
	DCAMPROP_ATTR_EFFECTIVE		= 0x00000200,	/* value is effective						*/
...
typedef enum _DCAMPROPATTRIBUTE2
{
	...
	DCAMPROP_ATTR2_CHANNELSEPARATEDDATA= 0x00040000,	/* Channel 0 value is total of each channels. */

	DCAMPROP_ATTR2__FUTUREUSE	= 0x0003FFFC	/* reserved */
} DCAMPROPATTRIBUTE2;
...
typedef enum _DCAMPROPMODEVALUE
{
	...
	DCAMPROP_SENSORMODE__PHOTONNUMBERRESOLVING	= 18,			/*	"PHOTON NUMBER RESOLVING"	*/
	DCAMPROP_SENSORMODE__WHOLELINES				= 19,			/*	"WHOLE LINES"			*/
	...
	DCAMPROP_READOUT_DIRECTION__FORWARDBIDIRECTION = 6,			/*	"FORWARD BIDIRECTION"	*/
	DCAMPROP_READOUT_DIRECTION__REVERSEBIDIRECTION = 7,			/*	"REVERSE BIDIRECTION"	*/
...
/*	DCAMPROP_READOUT_UNIT__LINE					= 1,	*/		/*	"LINE"					*/	/* reserved */
	...
	/* DCAM_IDPROP_MULTILINESENSOR_READOUTMODE */
	DCAMPROP_MULTILINESENSOR_READOUTMODE__SYNCACCUMULATE	= 1,	/*	"SYNC ACCUMULATE"		*/
	DCAMPROP_MULTILINESENSOR_READOUTMODE__SYNCAVERAGE		= 2,	/*	"SYNC AVERAGE"			*/
...
/*	DCAMPROP_OUTPUTTRIGGER_ACTIVE__PULSE		= 3,	*/		/*	"PULSE"					*/	/* reserved */
	...
	DCAMPROP_OUTPUTTRIGGER_KIND__GLOBALEXPOSURE	= 2,			/*	"EXPOSURE"				*/
	...
	DCAMPROP_OUTPUTTRIGGER_KIND__ANYROWEXPOSURE	= 6,			/*	"ANYROW EXPOSURE"		*/
...
/*	DCAMPROP_CONTRAST_CONTROL__FRONTPANEL		= 3,	*/		/*	"FRONT PANEL"			*/	/* reserved */
	...
	/* DCAM_IDPROP_IMAGEFILTER */
	DCAMPROP_IMAGEFILTER__THROUGH				= 0,			/*	"THROUGH"				*/
	DCAMPROP_IMAGEFILTER__PATTERN_1				= 1,			/*	"PATTERN 1"				*/
	...
	DCAMPROP_DEFECTCORRECT_METHOD__NEXT			= 5,			/*	"NEXT"					*/
	...
	/* DCAM_IDPROP_CONFOCAL_SCANMODE */
	DCAMPROP_CONFOCAL_SCANMODE__SIMULTANEOUS	= 1,			/*	"SIMULTANEOUS"			*/
	DCAMPROP_CONFOCAL_SCANMODE__SEQUENTIAL		= 2,			/*	"SEQUENTIAL"			*/

	/* DCAM_IDPROP_SUBUNIT_CONTROL */
	DCAMPROP_SUBUNIT_CONTROL__NOTINSTALLED		= 0,			/*	"NOT INSTALLED"			*/
	DCAMPROP_SUBUNIT_CONTROL__OFF				= 1,			/*	"OFF"					*/
	DCAMPROP_SUBUNIT_CONTROL__ON				= 2,			/*	"ON"					*/

	/* DCAM_IDPROP_SUBUNIT_PINHOLESIZE */
	DCAMPROP_SUBUNIT_PINHOLESIZE__ERROR			= 1,			/*	"ERROR"					*/
	DCAMPROP_SUBUNIT_PINHOLESIZE__SMALL			= 2,			/*	"SMALL"					*/
	DCAMPROP_SUBUNIT_PINHOLESIZE__MEDIUM		= 3,			/*	"MEDIUM"				*/
	DCAMPROP_SUBUNIT_PINHOLESIZE__LARGE			= 4,			/*	"LARGE"					*/
	...
	DCAMPROP_OUTPUTTRIGGER_KIND__EXPOSURE	= DCAMPROP_OUTPUTTRIGGER_KIND__GLOBALEXPOSURE,
...
/*	DCAM_IDPROP_MECHANICALSHUTTER_AUTOMODE		= 0x00200420,*/	/* R/W, mode,	"MECHANICAL SHUTTER AUTOMODE"	*/	/* reserved */
	...
	DCAM_IDPROP_NUMBEROF_REALTIMEGAINCORRECTREGION=0x003001A0,	/* R/W,	long,	"NUMBER OF REALTIME GAIN CORRECT REGION"*/

	/* color features */
	DCAM_IDPROP_VIVIDCOLOR						= 0x00300200,	/* R/W, mode,	"VIVID COLOR"			*/	/*[C7780]*/
	...
	DCAM_IDPROP_REALTIMEGAINCORRECTREGION_HPOS	= 0x00301000,	/* R/W,	long,	"REALTIME GAIN CORRECT REGION HPOS"		*/
	DCAM_IDPROP_REALTIMEGAINCORRECTREGION_HSIZE	= 0x00302000,	/* R/W,	long,	"REALTIME GAIN CORRECT REGION HSIZE"	*/

	DCAM_IDPROP__REALTIMEGAINCORRECTIONREGION	= 0x00000010,	/* the offset of ID for Nth REALTIME GAIN CORRECT REGION parameter	*/
...
/* Group: ALU */
	...
	DCAM_IDPROP_LINEAVERAGING					= 0x00380450,	/* R/W, long,	"LINE AVERAGING"	*/
	DCAM_IDPROP_IMAGEFILTER						= 0x00380460,	/* R/W, mode,	"IMAGE FILTER"	*/
	...
	DCAM_IDPROP_INTENSITY_GAMMA					= 0x00380560,	/* R/W, real,	"INTENSITY GAMMA"	*/
	DCAM_IDPROP_SENSORGAPCORRECT_MODE			= 0x00380620,	/* R/W, long,	"SENSOR GAP CORRECT MODE"	*/
	DCAM_IDPROP_ADVANCEDEDGEENHANCEMENT_MODE	= 0x00380630,	/* R/W, mode,	"ADVANCED EDGE ENHANCEMENT MODE"	*/
	DCAM_IDPROP_ADVANCEDEDGEENHANCEMENT_LEVEL	= 0x00380640,	/* R/W, long,	"ADVANCED EDGE ENHANCEMENT LEVEL"	*/
	...
	DCAM_IDPROP_TAPCALIB_OFFSET					= 0x00382000,	/* R/W, mode,	"TAP CALIB OFFSET"		*/
...
/* Group: READOUT */
	...
	DCAM_IDPROP_SHUTTER_MODE					= 0x00400150,	/* R/W, mode,	"SHUTTER MODE"			*/
	...
	DCAM_IDPROP_MULTILINESENSOR_READOUTMODE		= 0x00400380,	/* R/W, mode,	"MULTI LINE SENSOR READOUT MODE"	*/
	DCAM_IDPROP_MULTILINESENSOR_TOP				= 0x00400390,	/* R/W, long,	"MULTI LINE SENSOR TOP"	*/
	DCAM_IDPROP_MULTILINESENSOR_HEIGHT			= 0x004003A0,	/* R/W, long,	"MULTI LINE SENSOR HEIGHT"	*/
...
/* Group: TIMING */
	...
	DCAM_IDPROP_TRANSFERINFO_FRAMECOUNT			= 0x00410B10,	/* R/O, long,	"TRANSFER INFO FRAME COUNT" */
	DCAM_IDPROP_TRANSFERINFO_LOSTCOUNT			= 0x00410B11,	/* R/O, long,	"TRANSFER INFO LOST COUNT" */
...
/* Group: READOUT */
	...
	DCAM_IDPROP_IMAGE_TOPOFFSETBYTES			= 0x00420250,	/* R/O, long,	"IMAGE TOP OFFSET BYTES"*/
	...
	DCAM_IDPROP_BUFFER_ROWBYTES					= 0x00420330,	/* R/O, long,	"BUFFER ROWBYTES"		*/	/* dcambuf_attach() */
	DCAM_IDPROP_BUFFER_FRAMEBYTES				= 0x00420340,	/* R/O, long,	"BUFFER FRAME BYTES"		*/	/* dcambuf_attach() */
	DCAM_IDPROP_BUFFER_TOPOFFSETBYTES			= 0x00420350,	/* R/O, long,	"BUFFER TOP OFFSET BYTES"	*/	/* dcambuf_attach() */
	DCAM_IDPROP_BUFFER_PIXELTYPE				= 0x00420360,	/* R/O, DCAM_PIXELTYPE,	"BUFFER PIXEL TYPE"	*/	/* dcambuf_attach() */
...
/* Group: device buffer countrol */
	DCAM_IDPROP_DEVICEBUFFER_MODE				= 0x00490000,	/* R/W, mode,	"DEVICE BUFFER MODE"	*/
	DCAM_IDPROP_DEVICEBUFFER_FRAMECOUNTMAX		= 0x00490020,	/* R/O, long,	"DEVICE BUFFER FRAME COUNT MAX" */
...
/* Group: MAICO */
	DCAM_IDPROP_CONFOCAL_SCANMODE				= 0x00910010,	/* R/W, mode,	"CONFOCAL SCAN MODE"	*/
	DCAM_IDPROP_CONFOCAL_SCANLINES				= 0x00910020,	/* R/W, long,	"CONFOCAL SCANLINES"	*/
	DCAM_IDPROP_CONFOCAL_ZOOM					= 0x00910030,	/* R/W, long,	"CONFOCAL ZOOM"			*/
	DCAM_IDPROP_SUBUNIT_IMAGEWIDTH				= 0x009100e0,	/* R/O, long,	"SUBUNIT IMAGE WIDTH */

	DCAM_IDPROP_NUMBEROF_SUBUNIT				= 0x009100f0,	/* R/O, long,	"NUMBER OF SUBUNIT"			*/
	DCAM_IDPROP_SUBUNIT_CONTROL					= 0x00910100,	/* R/W, mode,	"SUBUNIT CONTROL"			*/
	DCAM_IDPROP_SUBUNIT_LASERPOWER				= 0x00910200,	/* R/W, long,	"SUBUNIT LASERPOWER"		*/
	DCAM_IDPROP_SUBUNIT_PMTGAIN					= 0x00910300,	/* R/W, real,	"SUBUNIT PMTGAIN"			*/
	DCAM_IDPROP_SUBUNIT_PINHOLESIZE				= 0x00910400,	/* R/O, long,	"SUBUNIT PINHOLE SIZE"		*/
	DCAM_IDPROP_SUBUNIT_WAVELENGTH				= 0x00910500,	/* R/O, long,	"SUBUNIT WAVELENGTH"		*/
	DCAM_IDPROP_SUBUNIT_TOPOFFSETBYTES			= 0x00910600,	/* R/O, long,	"SUBUNIT TOP OFFSET BYTES"	*/

	DCAM_IDPROP__SUBUNIT						= 0x00000010,	/* the offset of ID for Nth Subunit parameter */
